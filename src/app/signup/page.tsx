  ...
  return (
    <main className=" flex justify-center items-center min-h-screen">
      <div className="bg-primary p-4 rounded-md">
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text text-white ">Nome:</span>
          </div>
          <input
            type="password"
            value={nome}
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text text-white ">Repita a senha:</span>
          </div>
          <input
            type="password"
            value={password}
        ...
        <Link className="underline  w-full justify-center " href={"/login"}>
          <p className=" text-center mt-3">Ja possou conta</p>
        </Link>
      </div>
    </main>
  );
